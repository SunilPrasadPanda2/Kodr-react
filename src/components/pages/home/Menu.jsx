...
import { menuList } from "@/data/mydata/home/menu";
      ...
      <div className="header-menu__content">
        ...
        <div className="menu js-navList">
          ...
          <li className="menu-item-has-children">
              <Link to="/about" className="text-green-1">
                About 
              </Link>
            </li>
            ...
            <li className="menu-item-has-children">
              <Link
                data-barba
                to="#"
                className={menuItem == "Events" ? "activeMenu" : "text-green-1"}
              >
            ...
            <li className="menu-item-has-children">
              <Link
                data-barba
                to="#"
                className={menuItem == "Blog" ? "activeMenu" : "text-green-1"}
              >
            ...
            <li className="menu-item-has-children">
              <Link to="/contact" className="text-green-1" >
                Contact 
              </Link>
            </li>

            {/* this code is here for any future reference */}
