...
import { sidebarItems } from "@/data/mydata/admin/homeSidebarItems";
...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (
        !event.target.closest(".js-notif-toggle") &&
        !event.target.closest(".js-profile-toggle") &&
        !event.target.closest(".js-notification-button") &&
        !event.target.closest(".js-profile-button")
      ) {
                ...
                <div className="header__logo ml-30 md:ml-20">
                  <Link data-barba to="/">
                    <img
                      ...
                      src="/assets/img/logo/kodr2.png"
                      alt="logo"
                      style={{ height: "5vh" }}
                    />
                    <img
                      className="-dark-d-none"
                      src="/assets/img/logo/kodr1.png"
                      alt="logo"
                      style={{ height: "5vh" }}
                    />
                  </Link>
              ...
              <div className="d-flex items-center">
                <div className="d-flex items-center sm:d-none">
                  ...
                  >
                    <a
                      href="#"
                      className="d-flex items-center text-light-1 justify-center size-50 rounded-16 -hover-dshb-header-light js-notification-button"
