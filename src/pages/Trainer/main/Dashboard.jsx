...
import { totalCourse, coursesData } from "@/data/mydata/trainer/dashBoardData";
    ...
    <div className="dashboard__main">
      <div className="dashboard__content bg-light-4">
        ...
        <div className="row y-gap-30">
          {totalCourse.map((elm, i) => (
            <div key={i} className="col-xl-5 col-md-2">
              <div className="d-flex justify-between items-center py-35 px-30 rounded-16 bg-white -dark-bg-dark-1 shadow-4">
                <div>
                  <div className="col-xl-12 col-md-12 d-flex justify-between items-center text-24 lh-1 fw-700">
                    <div>{elm.title} :</div>
                    <div className="ms-3">
                      {elm.value}
                    </div>
        ...
        <div className="row y-gap-30">
          {coursesData.map((elm, i) => (
            <div key={i} className="col-xl-6 col-md-12">
              <div
                className="d-flex justify-between items-center py-35 px-30 rounded-16 bg-white -dark-bg-dark-1 shadow-4"
                style={{ height: "200px" }}
              >
                <div>
                  <div className="lh-1 fw-900">{elm.title}</div>
                  <div className="col-xl-12 col-md-12 d-flex justify-between items-center">
                    <div className="text-5 lh-1 fw-300 text-dark-1 mt-20">
                      Total Lesson : {elm.lessonCount}
                    </div>
                    <div className="text-5 lh-1 fw-300 text-dark-1 mt-20">
                  ...
                  <div className="col-xl-12 col-md-12 d-flex justify-between items-center">
                    <div className="text-5 lh-1 fw-300 text-dark-1 mt-20">
                      Original Price : {elm.originalPrice}
                    </div>
                    <div className="text-5 lh-1 fw-300 text-dark-1 mt-20">
                      Discount Price : {elm.discountedPrice}
                    </div>
                  </div>

                  <div className="text-5 lh-1 fw-600 text-dark-1 mt-20">
                    Total Students : {elm.totalStudents}
                  </div>
                  {/* <div className="lh-1 mt-25">
                    <span className="text-purple-1">${elm.new}</span> New Sales
                  </div> */}
